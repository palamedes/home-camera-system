...
(function () {
  ...
  const HELP = {
    ...
    'cameras.show_on_grid': ['On grid', 'Show the raw tile on the Cameras page and wall', 'When on, the raw camera tile appears on the Cameras page and the wall view. Turn it off to keep only this camera’s virtual (dewarped) views there.'],
    'cameras.show_on_dashboard': ['On dashboard', 'Show the raw tile on the front dashboard', 'Independent of “On grid”. A camera you watch constantly can sit on the dashboard while a rarely-needed one stays on the Cameras page only — or the reverse.'],
